...
--[[
    By Alejandro
    Increment the size of the paddle without exceding the maximum size.
]]
function Paddle:inc_size()
    if self.size < 4 then
...
--[[
    By Alejandro
    Decrement the size of the paddle without getting less than 1.
]]
function Paddle:dec_size()
    if self.size > 1 then
        self.size = self.size - 1
        self.width = self.width - 32
    end
