...
function BattleState:init(party, region, onExit)
    ...
    self.bottomPanel = Panel(0, VIRTUAL_HEIGHT - 80, VIRTUAL_WIDTH, 80)
...
function BattleState:triggerStartingDialogue()
    ...
    gStateStack:push(BattleMessageState(self, 'A wild creatures horde appeared!',
    ...
    function()
        ...
        gStateStack:push(BattleMessageState(self, prefix .. 'Go, ' .. names:sub(1, -3) .. '!',
